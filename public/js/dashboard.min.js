...
angular.module("RDash")
        ...
        .config(["$stateProvider", "$urlRouterProvider", function (t, e) {
                e.otherwise("/"), t.state("index", {url: "/", templateUrl: "templates/dashboard.html"})
                        ...
                        .state("user", {url: "/user", templateUrl: "templates/user.html"})

            }]);

angular.module("RDash").controller('LivroCtrl', function ($http, $scope, $filter, ngTableParams) {

    // $scope.livros = [
    //     {titulo: 'livro 1', autor: 'Autor 1', quantidade: 1, reservado: 0, disponivel: 1},
    //     {titulo: 'livro 2', autor: 'Autor 2', quantidade: 1, reservado: 0, disponivel: 1},
    //     {titulo: 'livro 3', autor: 'Autor 3', quantidade: 1, reservado: 0, disponivel: 1},
    // ];
    ...
    $scope.tableParams = new ngTableParams({
        ...
        sorting: {
            titulo: 'desc'     // initial sorting
        }
    }, {
        total: $scope.livros.length, // length of data

        getData: function ($defer, params) {
            var orderedData = params.sorting() ?
                    $filter('orderBy')($scope.livros, params.orderBy()) :
                    $scope.livros;
